                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos</h1>
                                <form action="insertarcliente.php" method="POST">
                                    ...
                                    <input type="text" class="form-control mb-3" name="category" placeholder="Estado">
                                    <input type="text" class="form-control mb-3" name="priority" placeholder="Prioridad">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="actualizarcliente.php?id=<?php echo $row['id'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="deletecliente.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
