    ...
    <br><br>
            ...
            <div class="container mt-5">
                    <div class="row"> 
                        ...
                        <div class="col-md-3">
                            <h1>Ingrese datos</h1>
                                <form action="insertarpromotor.php" method="POST">

                                    <input type="text" class="form-control mb-3" name="id" placeholder="id">
                                    <input type="text" class="form-control mb-3" name="nombre" placeholder="Nombre">                                                                        
                                    <input type="text" class="form-control mb-3" name="responsable" placeholder="Responsable">
                                ...
                                <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <th><a href="actualizarpromotor.php?id=<?php echo $row['id'] ?>" class="btn btn-info">Editar</a></th>
                                                <th><a href="deletepromotor.php?id=<?php echo $row['id'] ?>" class="btn btn-danger">Eliminar</a></th>                                        
                                            </tr>
                                        <?php 
                                            }
                                        ?>
